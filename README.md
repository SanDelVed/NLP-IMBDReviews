...
Lo último que realizamos para esta etapa del proyecto fue eliminar las **stopwords** (palabras sin significado como artículos, pronombres, preposiciones, etc.) de las reviews para que el aprendizaje del modelo sea mas eficiente. Para ello utilizamos la librería **nltk** y el método **stopwords** de la misma.
